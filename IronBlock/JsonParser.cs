  ...
  public class JsonParser : Parser<JsonParser>
  {
    ...
    private void ParseVariables(JToken jdoc, Workspace workspace)
    {
      ...
      foreach (var variable in variables)
      {
        ...
        workspace.Blocks.Add(new GlobalVariablesSet
        {
          Fields = { new() { Name = "VAR", Value = name, } },
    ...
    private IBlock ParseBlock(JToken jblock)
    {
    ...
    private void ParseField(JToken jfield, IBlock block)
    {
    ...
    private void ParseInput(JToken jvalue, IBlock block)
    {
    ...
    private static void ParseComment(JToken jicon, IBlock block)
    {
    ...
    private void ParseMutation(JToken jextra, IBlock block)
    {
      if (!jextra.HasValues)
        return;
